...
### Executive Overview
![Executive overview: portfolio KPIs and platform summary](screenshots/01_executive_overview.png)
...
### Roll Rate Analysis
![Roll rate matrix and early delinquency trend chart](screenshots/02_roll_rate_matrix.png)
...
![Scenario engine: shock inputs, EL waterfall and segment sensitivity](screenshots/03_scenario_engine.png)
...
![CDR heatmap and exposure decay curve by vintage](screenshots/04_vintage_lifecycle.png)
...
![VSE: scenario inputs, CDR delta and attribution heatmap](screenshots/05_vintage_scenario_engine.png)
...
**Note:** The full commercial package (production PBIX, full documentation, commercial license) is available only after purchase. See `docs/COMMERCIAL_LICENSE.txt`.

---

## How to buy
Purchase via: **[YOUR PAYMENT LINK — Gumroad / Paddle / Stripe]**  
After payment you will receive a secure download link and license file by email.

**Pilot offer:** first 3 buyers receive 15% discount in exchange for a short testimonial.
...
## Contact
- Sales: isarijanlibi@outlook.com 
- Support: isarijanlibi@outlook.com
